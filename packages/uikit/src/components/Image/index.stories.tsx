...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://testnet.herbswap.finance/images/tokens/${token.address[4002]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://testnet.herbswap.finance/images/tokens/${token.address[4002]}.png`;
        const secondarySrc = `https://testnet.herbswap.finance/images/tokens/${tokens[randomTokenIndex].address[4002]}.png`;
