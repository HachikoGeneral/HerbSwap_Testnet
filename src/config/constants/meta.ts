...
export const DEFAULT_META: PageMeta = {
  ...
  image: 'https://herbswap.app/images/helpcat.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Herbswap exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for Herbswap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Herbswap exchanges.' },
      ...
      '/pancake-squad': { basePath: true, title: t('HerbSwap Squad') },
    },
    defaultTitleSuffix: t('HerbSwap'),
  }
}
